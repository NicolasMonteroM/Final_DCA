...
public class Register {
	...
	public Register(PApplet app) {
		...
		cp5.addButton("registerNewPlayer").setPosition(350,330).setSize(70,30).setColorBackground(app.color(255,255,255,1))
		.setColorForeground(app.color(255,255,255,20))
		.setColorActive(app.color(255,255,255,60)).getCaptionLabel().hide();
		
		cp5.addButton("Leaderboard").setPosition(333,365).setSize(105,30).setColorBackground(app.color(255,255,255,1))
		.setColorForeground(app.color(255,255,255,20))
		.setColorActive(app.color(255,255,255,60)).getCaptionLabel().hide();
